        ...
        <div className="text-gray-300 mx-auto glassmorph py-10 text-sm font-light font-Koho">
            ...
            <div className="w-11/12 lg:w-10/12 flex flex-wrap justify-around mx-auto">
                ...
                <div>
                    ...
                    <ul>
                        <Link href={{pathname: '/products'}}><li className="hover:text-gray-100 cursor-pointer">Posts</li></Link>
                        <Link href={{pathname: '/new'}}><li className="hover:text-gray-100 cursor-pointer">Friends</li></Link>
                        <Link href={{pathname: '/men'}}><li className="hover:text-gray-100 cursor-pointer">Explore</li></Link>
                        <Link href={{pathname: '/women'}}><li className="hover:text-gray-100 cursor-pointer">Extras</li></Link>
                        <Link href={{pathname: '/unisex'}}><li className="hover:text-gray-100 cursor-pointer">Login</li></Link>
                    </ul>
                </div>
                <div>
